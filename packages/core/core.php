...
<head>
	...
	<title>{$title}</title>
	<link rel="icon" type="image/vdn.microsoft.icon" href="{$httproot}packages/core/public/api.ico" />
	<link rel="stylesheet" type="text/css" href="{$httproot}packages/core/public/api.css" />
	<!--
